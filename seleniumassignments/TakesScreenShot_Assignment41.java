...
public class TakesScreenShot_Assignment41
{
	public static void main(String[] args) throws IOException 
	{
		...
		scname = date_sep[0] +"-" + date_sep[1] +"-"+ date_sep[2] + "-" + date_sep[5] + "-" + time;	
		...
		File Destination = new File("C:\\Users\\Chinnu\\eclipse-workspace\\SeleniumProject\\src\\" + scname + ".png");
